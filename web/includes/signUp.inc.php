...
if( isset($_POST['sign-up']) ){
    ...
    push_notification($database_connection, (int)get_max_id($database_connection, 'table_akun_pengguna', 'user_id'), "Selamat Datang", "Selamat datang di Wingspart25, selamat berbelanja {$_COOKIE[get_max_id($database_connection, 'table_akun_pengguna', 'user_id')]} :D");
