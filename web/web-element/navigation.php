...
<html>
    ...
    <body> 
        <nav class="navigation bg-main">
            <div class="container">
                <a href="index.php?page=home&logined=true&id_user=<?=$id_user?>" class="wingspart25-logo" style="grid-area: box-1"></a>
                ...
                <a class="btn cart-btn bg-transparant" href="index.php?page=cart&logined=true&id_user=<?=$id_user?>" class="cart-button" style="grid-area: box-3"><img src="icon/icon keranjang.svg" alt="keranjang"></a>
        ...
        <div class="profile-menu" id="profile-menu">
            <?php if($logined && $id_user != 0) {?>
                ...
                <a href="index.php?page=profile&logined=true&id_user=<?=$id_user?>"><button class="btn account-btn bg-light-color">Profile</button></a>
